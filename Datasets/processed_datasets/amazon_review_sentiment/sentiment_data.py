...
class SentimentData:
    def __init__(self, type='train', chunk_size=10000):
        ...
        if type in ['train']:
            file_path='Datasets/amazon_review_sentiment/train.csv'
        else:
            file_path='Datasets/amazon_review_sentiment/test.csv'
        ...
        self.output_path = f'Datasets/processed_datasets/amazon_review_sentiment/{type}-DATA/processed_{type}_data.csv'
    ...
    def process_data(self):
        ...
        for chunk in pd.read_csv(self.file_path, header=None, names=['polarity', 'title', 'review'], chunksize=self.chunk_size):
            chunk['polarity'] = chunk['polarity'] - 1
...
if __name__ == '__main__':
    ...
    print(data.get_data()['polarity'].value_counts())

    # make test data
    SentimentData(type='test')
