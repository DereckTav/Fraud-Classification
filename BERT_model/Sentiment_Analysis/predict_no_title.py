...
def main(config_path, model_path):
    ...
    cm_path = "BERT_model/Sentiment_Analysis/outputs/figures/confusion_no_title_matrix.png"
    ...
    # Save predictions to CSV
    predictions_path = "BERT_model/Sentiment_Analysis/outputs/predictions/test_no_title_predictions.csv"
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model', type=str, default=os.path.join(os.path.dirname(os.path.abspath(__file__)), 'model/no_title.bin'), help='Path to model weights')
