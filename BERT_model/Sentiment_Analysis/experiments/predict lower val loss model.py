...
def main(config_path, model_path):
    ...
    cm_path = "BERT_model/Sentiment_Analysis/outputs/figures/confusion_matrix_(loss).png"
    ...
    # Save predictions to CSV
    predictions_path = "BERT_model/Sentiment_Analysis/outputs/predictions/test_predictions_(loss).csv"
